      ...
      html: `
          ...
          <form id="loginForm" method="POST" class="needs-validation" novalidate autocomplete="off">
              ...
              <div class="text-center">
                  <button id="loginButton" class="btn d-inline-flex align-items-center justify-content-center">Login</button>
                  <div id="textss" class="text-center C">
                      <div class="social-text">
                          <span class="show-text" style="padding-bottom: -20px">Não tem nenhuma conta?</span>
                          <span id="open_log_alert" class="show-link text-primary text-underline">Registe-se</span>
                      </div>
                  </div>
                  <div id="textss" class="text-center C">
      ...
      Swal.fire({
          html: `
              ...
              <form id="registerForm" method="POST" class="needs-validation" novalidate autocomplete="off">
                  ...
                  <div class="text-center">
                      <button id="registerButton" type="submit" class="btn d-inline-flex align-items-center justify-content-center">Register</button>
                  </div>
                  <div id="textss" class="text-center C">
                      <span class="show-text">Precisa de ajuda?</span>
                      <span class="show-link"><a href="support.html">Visite o nosso suporte</a></span><br />
