...
const map ={
    getSpots: async () =>{
        ...
        `
        select com.id as id, com.name as naeme, com.rating as rating, st_asgeojson(loc.geom) as location , com.category::TEXT AS category, 'commercial-spot' as spot_type, address.street as street, address.zipcode as zipcode
